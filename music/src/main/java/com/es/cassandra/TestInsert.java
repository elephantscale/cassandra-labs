...
public class TestInsert {
	...
	try {
	    ...
	    // --- songs
	    // TODO 1 : uncomment the following section, after completing song.save() function
	    /*
	    ...
	    */
	    ...
	    // playlist
	    // TODO 2 : uncomment the following section, after completing playlist.save() function
	    /*
	    ...
	    */
	    ...
	    // users
	    // TODO 3 : uncomment the following section, after completing user.save() function
	    /*
	    User u = new User();
	    u.setId(userid);
	    u.setName("Joe 1");
